...
import AddUserToChannelModal from 'components/add_user_to_channel_modal/add_user_to_channel_modal.jsx';
...
describe('components/AddUserToChannelModal', () => {
    ...
    describe('didSelectChannel', () => {
        it('should fetch this user\'s membership for the selected channel', () => {
            const props = {...baseProps};
